  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4 md:mb-0">Mi Dashboard</h1>
        <Link 
          href="/events/create" 
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-red-50 p-6 rounded-md border border-red-100 text-red-600 flex items-start">
          ...
          <div className="text-center py-16">
            <div className="bg-amber-50 p-8 rounded-lg inline-block max-w-lg mx-auto shadow-sm">
              ...
              <p className="text-gray-600 mb-6">Crea tu primer evento para comenzar a capturar momentos especiales con tus invitados.</p>
              <Link 
                href="/events/create" 
                className="btn btn-primary inline-flex items-center justify-center"
              >
      ...
      {!isLoading && !error && events.length > 0 && (
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-xl font-bold mb-6 text-gray-800 border-b pb-4">Estadísticas</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-orange-50 p-6 rounded-lg border border-orange-100 transition-transform hover:translate-y-[-5px]">
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-100 transition-transform hover:translate-y-[-5px]">
              <div className="flex items-center mb-1">
            ...
            <div className="bg-green-50 p-6 rounded-lg border border-green-100 transition-transform hover:translate-y-[-5px]">
              <div className="flex items-center mb-1">
